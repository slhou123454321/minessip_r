...
//            }
//            ChartPlay.showLineChart(chartRes, lists1.get(0),"电流1", Color.RED,0);
//            ChartPlay.addLine(chartRes, lists1.get(1),"电流2", Color.GREEN ,0);
//            ChartPlay.addLine(chartRes, lists1.get(2),"电流3", Color.BLUE  ,0);       //ChartPlay.addLine(chartone,lists_1.get(3),"测道4", Color.TRANSPARENT ,10);
//            fillTableData(ave);
//        } else {
...
//        }
    ...
    private void fillTableData(ArrayList<ArrayList<Float>> ave) {
        ...
        // I3数据
        ch3.setText(String.format("%.4f", ave.get(0).get(1)));
        che3.setText("-");
        ch_p3.setText(String.format("%.4f", ave.get(1).get(1)));
        ch_pe3.setText("-");
    }
}